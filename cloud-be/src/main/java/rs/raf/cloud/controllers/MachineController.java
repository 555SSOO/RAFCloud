...
public class MachineController {
    ...
    void startMachineByUID(@RequestParam("machineUID") String UID) {
        getMachineService().startMachine(UID);
    }

    @RequestMapping("/stop")
    void stopMachineByUID(@RequestParam("machineUID") String UID) {
        getMachineService().stopMachine(UID);
    }

    @RequestMapping("/restart")
    void restartMachineByUID(@RequestParam("machineUID") String UID) {
